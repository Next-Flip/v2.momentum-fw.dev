...
const messages: MessageSchema = {
    ...
    releases_devbuild: "Dev build",
    releases_devbuilds: "Dev builds",
    releases_install: "Install via...",
    releases_reinstall: "Reinstall via...",
    releases_install_tooltip:
        "For more info on these installation methods or using a zipped archive, you can go here: <a href='{{url}}' target='_blank' rel='noopener' class='text-vp-alternate-1 hover:text-vp-alternate-2 underline transition-colors duration-100 font-medium'>{{text}}</a>",
    ...
    releases_files_dev_description:
        "These files include SDK packages, binaries, and scripts for advanced users to build applications or modify firmware.",
    ...
    connection_serial_not_supported: "Browser not supported",
    connection_preferred_connection: "Connection",
    connection_preferred_both: "USB / BT",
    connection_preferred_usb: "USB only",
    connection_preferred_bt: "BT only",
    connection_connect_usb: "USB",
    connection_connect_bt: "Bluetooth",
    connection_bt_recommended_usb:
        "Bluetooth is supported*, but USB Serial is recommended for much faster and more stable transfers.",
    connection_bt_show_all: "Can't find your Flipper? Show all devices",
    ...
    connection_disconnect_warning: "Don't move your Flipper - this will take a while!",
    missing: "Missing",
    corrupt: "Corrupt",
    installed: "Installed",
    ...
    update_stage_creating_directory: "Creating directory: {{name}}",
    update_stage_uploading_file: "Uploading file: {{name}} ({{count}}/{{total}})",
    ...
    update_stage_loading_manifest: "Loading update manifest...",
    update_stage_rebooting: "Rebooting Flipper...",
    update_stage_done: "Upload complete!",
    update_stage_flipper_updating: "Flipper is now updating...",
    ...
    updater_firmware_branch_label: "Branch",
    ...
    updater_flipper_not_connected_subtitle:
        "Plug in your Flipper or turn on Bluetooth. qFlipper, Flipper Lab / App must be fully disconnected!",
    updater_matching_release_warning: "The {{type}} matches the current version on your Flipper.",
    updater_download_release: "Download .tgz",
    updater_downloaded: "Downloaded",
    ...
    updater_go_to_branch: "Go to branch",
    ...
    updater_serial_unsupported: "Browser Not Supported",
    updater_serial_unsupported_subtitle:
        "Your browser does not support USB Serial or Bluetooth. Use a Chromium-based browser like <a href='https://www.google.com/chrome/' target='_blank' rel='noopener'>Chrome</a>, <a href='https://www.microsoft.com/en-us/edge' target='_blank' rel='noopener'>Edge</a>, <a href='https://www.opera.com/download' target='_blank' rel='noopener'>Opera</a>, or <a href='https://play.google.com/store/apps/details?id=com.android.chrome&hl=en_US' target='_blank' rel='noopener'>Chrome for Android</a>.\nLearn more <a href='/wiki/Installation/#web-updater' target='_blank' rel='noopener'>here</a>.",
    updater_resize_panels: "Resize panels",
    updater_bluetooth_warning:
        'For the best experience, use USB. <a href="{{url}}" class="text-vp-brand-1 hover:text-vp-brand-2 hover:underline transition-colors duration-100 font-medium">Learn why</a>',
