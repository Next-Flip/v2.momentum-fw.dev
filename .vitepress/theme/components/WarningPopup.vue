...
<template>
    ...
    >
        <div
            ...
            class="fixed bottom-0 right-0 z-[9999] flex flex-col max-w-sm w-full bg-vp-bg dark:bg-vp-bg rounded-xl shadow-2xl border border-vp-divider overflow-hidden backdrop-blur p-5 gap-y-4 m-5"
            role="dialog"
            aria-modal="true"
